...
class SituacoesController extends BaseController {
    
    function SituacoesController() {
        parent::__construct();
    }
    ...
    private function exibirTelaListar($dados = array()) {
        $view = new View('views/listarSituacoes.phtml');
    ...
    private function trabalharDadosManter($situacao, $mensagem = "") {
        return array( 'mensagem' => $mensagem
                    , 'registro' => $situacao );
    }
    
    private function exibirTelaManter($dados = array()) {
        $view = new View('views/manterSituacoes.phtml');
        $view->setParams($dados);
        $view->showContents();
    }
