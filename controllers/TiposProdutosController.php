...
class TiposProdutosController extends BaseController {
    
    function TiposProdutosController() {
        parent::__construct();
    }
    ...
    private function exibirTelaListar($dados = array()) {
        $view = new View('views/listarTiposProdutos.phtml');
    ...
    private function trabalharDadosManter($tiposProdutos, $mensagem = "") {
        return array( 'mensagem' => $mensagem
                    , 'registro' => $tiposProdutos );
    }
